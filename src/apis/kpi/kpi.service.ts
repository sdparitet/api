...
export class Kpi_Service {
   ...
   async up() {
      const groups = {
         ...
         'Бизнес процессы': [
            {
               unit: '% технических простоев оборудования',
               name: 'Отсутствие технических простоев обоудования Цель не более 3%',
            },
            { unit: '% своевременного выполнение заявок и ТЗ от КП и ОГТ', name: 'Выполнение заявок' },
            {
               unit: '% не проведнных ТО от запланированных в месяц',
               name: 'Соблюдение плана ТОиР Цель - 0 (2 допускается)',
            },
            {
               unit: 'Наличие нарушений по результатам аудитов, их кол-во или оценка за аудит',
               name: 'Отсутствие замечаний по внутренним аудитем',
            },
         ],
         'Безопсность': [
         ...
         'Сотрудники': [
            ...
            {
               unit: ' ',
               name: '% сотрудников повысивших квалификацию за год (освоение нового оборуд или смежной проф)',
            },
